...
The same 68 tools are also available with nothing to install: Zuuna runs a hosted MCP
...
68 tools, grouped by area. Every tool works with any valid token; the Scopes column lists
